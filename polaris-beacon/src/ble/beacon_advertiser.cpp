...
BeaconAdvertiser::BeaconAdvertiser(uint32_t beacon_id,
...
void BeaconAdvertiser::updateAdvertisement() {
    ...
    signBeaconBroadcast(payload_content.signature, _beacon_id, current_counter, _secret_key, _public_key);
    ...
    raw_adv_payload[idx++] = 1 + data_len_for_adv; // Length of this AD structure field (Type + Data)
